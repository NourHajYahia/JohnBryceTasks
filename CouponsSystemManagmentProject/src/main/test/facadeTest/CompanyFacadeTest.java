...
public class CompanyFacadeTest extends FacadeTest{
    ...
    public void runTest() {
        ...
        coupon = new Coupon(Category.ELECTRICITY, "aaa", "aaa aaa",new Date(System.currentTimeMillis()) , new Date(System.currentTimeMillis() + 1000*30) , 5,
                100.0, "aaa");
        ...
        coupon = new Coupon(Category.FOOD, "bbb", "ccc ccc", new Date(), new Date(System.currentTimeMillis() + 1000*60*60*24), 2, 150.0,
                "ccc");
        addCouponTest(coupon);
        System.out.println();
        // ------------------------------------------------------------------------------------------------------
